...
Entry point. Two modes:
  ...
  python -m main once     # one poll cycle, then exit  (GitHub Actions)
  python -m main loop     # poll forever                (always-on server)
  python -m main mock     # test the pipeline with fake data, no network
"""
